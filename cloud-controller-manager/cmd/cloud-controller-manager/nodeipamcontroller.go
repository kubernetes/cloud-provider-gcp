...
import (
	...
	nodeipamcontrolleroptions "k8s.io/cloud-provider-gcp/cloud-controller-manager/cmd/cloud-controller-manager/options"
	nodeipamcontroller "k8s.io/cloud-provider-gcp/cloud-controller-manager/pkg/controller/nodeipam"
	nodeipamconfig "k8s.io/cloud-provider-gcp/cloud-controller-manager/pkg/controller/nodeipam/config"
	"k8s.io/cloud-provider-gcp/cloud-controller-manager/pkg/controller/nodeipam/ipam"
