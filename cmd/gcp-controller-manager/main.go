...
var (
	...
	csrApproverListReferrersInitialInterval = pflag.Duration("csr-gce-list-referrers-initial-interval", 5*time.Second, "Initial interval of the exponential back-off retries for calls to listReferrers, defaults to 5s.")
	csrApproverListReferrersMaxInterval     = pflag.Duration("csr-gce-list-referrers-max-interval", 30*time.Second, "Maximal interval of the exponential back-off retries for calls to listReferrers, defaults to 30s.")
	csrApproverListReferrersMaxElapsedTime  = pflag.Duration("csr-gce-list-referrers-max-elapsed-time", 5*time.Minute, "Maximal elapsed time of the exponential back-off retries for calls to listReferrers, defaults to 5m.")
...
func main() {
	...
	s := &controllerManager{
		...
		csrApproverListReferrersConfig: gceInstanceListReferrersConfig{
			...
			maxInterval:     *csrApproverListReferrersMaxInterval,
			maxElapsedTime:  *csrApproverListReferrersMaxElapsedTime,
		},
