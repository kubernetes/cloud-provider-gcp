...
import (
	...
	kubectrlmgrserviceconfigv1alpha1 "k8s.io/kubernetes/pkg/controller/service/config/v1alpha1"
)
...
func SetDefaults_CloudControllerManagerConfiguration(obj *CloudControllerManagerConfiguration) {
	...
	kubectrlmgrserviceconfigv1alpha1.RecommendedDefaultServiceControllerConfiguration(&obj.ServiceController)
}
