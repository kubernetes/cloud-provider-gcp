...
# We use to build with a go workspace; the problem is that this isn't the code in our repo and isn't the code in vendor.
# We keep the code, but guard it behind an env var (USE_GO_WORKSPACE) which we don't set.
