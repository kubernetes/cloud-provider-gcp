...
func TestStore_GetCIDRBlockByCIDRAndNetwork(t *testing.T) {
	...
	_, exists, err := s.GetCIDRBlockByCIDRAndNetwork(context.Background(), cidr, network1)
	if err != nil {
	...
	_, exists, err = s.GetCIDRBlockByCIDRAndNetwork(context.Background(), cidr, network2)
	if err != nil {
