...
PROTOCOL ?= gs:
REGISTRY_PATH ?= kubernetes-release/release/v1.13.2
...
_output/ccm-vendor.tar.gz: build/src
	...
	mkdir -p _output/ccm/vendor/k8s.io/api/core _output/ccm/vendor/k8s.io/api/admission _output/ccm/vendor/k8s.io/api/admissionregistration _output/ccm/vendor/k8s.io/api/apps _output/ccm/vendor/k8s.io/api/auditregistration _output/ccm/vendor/k8s.io/api/authentication _output/ccm/vendor/k8s.io/api/authorization _output/ccm/vendor/k8s.io/api/autoscaling _output/ccm/vendor/k8s.io/api/batch _output/ccm/vendor/k8s.io/api/certificates _output/ccm/vendor/k8s.io/api/coordination _output/ccm/vendor/k8s.io/api/events _output/ccm/vendor/k8s.io/api/extensions _output/ccm/vendor/k8s.io/api/networking _output/ccm/vendor/k8s.io/api/policy _output/ccm/vendor/k8s.io/api/rbac _output/ccm/vendor/k8s.io/api/scheduling _output/ccm/vendor/k8s.io/api/settings _output/ccm/vendor/k8s.io/api/storage
	...
	cp -rf build/src/staging/src/k8s.io/api/auditregistration/v1alpha1 _output/ccm/vendor/k8s.io/api/auditregistration
	...
	cp -rf build/src/staging/src/k8s.io/apimachinery/pkg/util/version _output/ccm/vendor/k8s.io/apimachinery/pkg/util
	...
	cp -rf build/src/staging/src/k8s.io/apiserver/pkg/authentication/token/cache _output/ccm/vendor/k8s.io/apiserver/pkg/authentication/token
	...
	cp -rf build/src/staging/src/k8s.io/apiserver/pkg/util/globalflag _output/ccm/vendor/k8s.io/apiserver/pkg/util
	...
	cp -rf build/src/staging/src/k8s.io/apiserver/plugin/pkg/audit/dynamic _output/ccm/vendor/k8s.io/apiserver/plugin/pkg/audit
	...
	mkdir -p _output/ccm/vendor/k8s.io/client-go/listers/admissionregistration _output/ccm/vendor/k8s.io/client-go/listers/auditregistration _output/ccm/vendor/k8s.io/client-go/listers/apps _output/ccm/vendor/k8s.io/client-go/listers/autoscaling _output/ccm/vendor/k8s.io/client-go/listers/batch _output/ccm/vendor/k8s.io/client-go/listers/certificates _output/ccm/vendor/k8s.io/client-go/listers/coordination _output/ccm/vendor/k8s.io/client-go/listers/core _output/ccm/vendor/k8s.io/client-go/listers/events _output/ccm/vendor/k8s.io/client-go/listers/extensions _output/ccm/vendor/k8s.io/client-go/listers/networking _output/ccm/vendor/k8s.io/client-go/listers/policy _output/ccm/vendor/k8s.io/client-go/listers/rbac _output/ccm/vendor/k8s.io/client-go/listers/scheduling _output/ccm/vendor/k8s.io/client-go/listers/settings _output/ccm/vendor/k8s.io/client-go/listers/storage
	...
	cp -rf build/src/staging/src/k8s.io/client-go/listers/auditregistration/v1alpha1 _output/ccm/vendor/k8s.io/client-go/listers/auditregistration
	...
	cp -rf build/src/vendor/k8s.io/klog _output/ccm/vendor/k8s.io
	...
	cp -rf build/src/pkg/apis/apps _output/ccm/vendor/k8s.io/kubernetes/pkg/apis
	...
	#cp -rf build/src/pkg/util/prometheusclientgo _output/ccm/vendor/k8s.io/kubernetes/pkg/util
	cp -rf build/src/pkg/util/resizefs _output/ccm/vendor/k8s.io/kubernetes/pkg/util
	...
	mkdir -p _output/ccm/vendor/sigs.k8s.io
	cp -rf build/src/vendor/sigs.k8s.io/yaml _output/ccm/vendor/sigs.k8s.io
	...
	cp -rf build/src/vendor/github.com/gogo/protobuf/gogoproto _output/ccm/vendor/github.com/gogo/protobuf
	cp -rf build/src/vendor/github.com/gogo/protobuf/proto _output/ccm/vendor/github.com/gogo/protobuf
	cp -rf build/src/vendor/github.com/gogo/protobuf/protoc-gen-gogo _output/ccm/vendor/github.com/gogo/protobuf
	...
	mkdir -p _output/ccm/vendor/k8s.io/cloud-provider
	cp -rf build/src/pkg/cloudprovider/providers/gce _output/ccm/pkg/cloudprovider/providers
	cp build/src/vendor/k8s.io/cloud-provider/*.go _output/ccm/vendor/k8s.io/cloud-provider
