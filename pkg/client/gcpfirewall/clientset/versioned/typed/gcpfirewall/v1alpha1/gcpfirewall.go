...
import (
	...
	scheme "k8s.io/cloud-provider-gcp/pkg/client/gcpfirewall/clientset/versioned/scheme"
)
...
type GCPFirewallInterface interface {
	Create(ctx context.Context, gCPFirewall *v1alpha1.GCPFirewall, opts v1.CreateOptions) (*v1alpha1.GCPFirewall, error)
	Update(ctx context.Context, gCPFirewall *v1alpha1.GCPFirewall, opts v1.UpdateOptions) (*v1alpha1.GCPFirewall, error)
	UpdateStatus(ctx context.Context, gCPFirewall *v1alpha1.GCPFirewall, opts v1.UpdateOptions) (*v1alpha1.GCPFirewall, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.GCPFirewall, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.GCPFirewallList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GCPFirewall, err error)
...
func (c *gCPFirewalls) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GCPFirewallList, err error) {
