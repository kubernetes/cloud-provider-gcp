...
func NewConfig(codecs serializer.CodecFactory) *Config {
	...
	return &Config{
		...
		WatchRequestWaitGroup:          &utilwaitgroup.RateLimitedSafeWaitGroup{},
		LegacyAPIGroupPrefixes:         sets.New(DefaultLegacyAPIPrefix),
		DisabledPostStartHooks:         sets.Set[string]{},
		PostStartHooks:                 map[string]PostStartHookConfigEntry{},
		...
		LongRunningFunc:                     genericfilters.BasicLongRunningRequestCheck(sets.New("watch"), sets.Set[string]{}),
		lifecycleSignals:                    lifecycleSignals,
...
func NewRequestInfoResolver(c *Config) *apirequest.RequestInfoFactory {
	apiPrefixes := sets.New(strings.Trim(APIGroupPrefix, "/")) // all possible API prefixes
