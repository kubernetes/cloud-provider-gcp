module k8s.io/cloud-provider-gcp/test/integration/ccm
...
require (
	...
	k8s.io/cloud-provider-gcp v0.0.0-20240905115332-8929defaa3f0
...
replace k8s.io/cloud-provider-gcp/providers => ../../../providers
